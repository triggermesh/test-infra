...
import (
	...
	commontest "github.com/triggermesh/test-infra/test/e2e/common"
	"github.com/triggermesh/test-infra/test/e2e/framework"
	e2ekubectl "github.com/triggermesh/test-infra/test/e2e/framework/kubectl"
	e2emanifest "github.com/triggermesh/test-infra/test/e2e/framework/manifest"
	e2enode "github.com/triggermesh/test-infra/test/e2e/framework/node"
	e2epod "github.com/triggermesh/test-infra/test/e2e/framework/pod"
	e2ereporters "github.com/triggermesh/test-infra/test/e2e/reporters"
	testutils "github.com/triggermesh/test-infra/test/utils"
...
func RunE2ETests(t *testing.T) {
	...
	ginkgo.RunSpecsWithDefaultAndCustomReporters(t, "TriggerMesh e2e suite", r)
}
...
func runKubernetesServiceTestContainer(c clientset.Interface, ns string) {
	...
	defer func() {
		if err := c.CoreV1().Pods(ns).Delete(p.Name, &metav1.DeleteOptions{}); err != nil {
