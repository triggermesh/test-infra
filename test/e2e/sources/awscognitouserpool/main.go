...
import (
	...
	e2ecognitouserpool "github.com/triggermesh/test-infra/test/e2e/framework/aws/cognitouserpool"
	...
	Context("a source watches an existing userpool", func() {
		...
		BeforeEach(func() {
			...
			By("creating a Cognito userpool", func() {
				...
				// TODO: remove after https://github.com/triggermesh/test-infra/issues/59 is resolved
