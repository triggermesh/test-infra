...
/* This test suite requires:
   ...
   - Google Cloud Credentials in json exported in the environment as GOOGLECLOUD_AUDITLOGS_KEY
...
const (
	...
	credsEnvVar   = "GOOGLECLOUD_AUDITLOGS_KEY"
...
var _ = Describe("Google Cloud AuditLogs source", func() {
	...
	Context("a source watches a Google Cloud AuditLogs Sink configured with PubSub", func() {
		...
		When("a new pubsub topic is created", func() {
			var topic *pubsub.Topic

			BeforeEach(func() {
				By("creating pubsub topic", func() {
