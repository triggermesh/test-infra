...
import (
	...
	e2erepo "github.com/triggermesh/test-infra/test/e2e/framework/gcloud/repositories"
)

/* This test suite requires:

   - Google Cloud Credentials in json exported in the environment as GOOGLECLOUD_REPOSITORIES_KEY
...
const (
	...
	credsEnvVar   = "GOOGLECLOUD_REPOSITORIES_KEY"
