...
func (config *RCConfig) GetKind() schema.GroupKind {
	return CoreKind("ReplicationController")
}

func (config *RCConfig) GetGroupResource() schema.GroupResource {
	return CoreResource("replicationcontrollers")
}

func (config *RCConfig) GetGroupVersionResource() schema.GroupVersionResource {
	return CoreSchemeGroupVersion.WithResource("replicationcontrollers")
}
...
func (config *SecretConfig) Stop() error {
	if err := DeleteResourceWithRetries(config.Client, CoreKind("Secret"), config.Namespace, config.Name, metav1.DeleteOptions{}); err != nil {
...
func (config *ConfigMapConfig) Stop() error {
	if err := DeleteResourceWithRetries(config.Client, CoreKind("ConfigMap"), config.Namespace, config.Name, metav1.DeleteOptions{}); err != nil {
